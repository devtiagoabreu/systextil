--CARGA DE CONTAS A RECEBER - TÍTULOS EM ABERTO - EM HOMOLOGAÇÃO
--fatu_070
...
WHERE
	...
	--NP.Tem_Baixas = '' OR
	NP.Tem_Baixas is null and
	NP.Vencimento_Parcelas BETWEEN '2022-11-01 00:00:00' AND '2022-11-30 00:00:00' --AND
	--NP.Empresa_Parcelas+NP.Documento_Parcelas+NP.Serie+NP.Parcela_Parcelas NOT IN(SELECT Empresa+Documento+Serie+Parcela FROM DBMicrodata.dbo.Rec_Baixas) 
